	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (input.equalsIgnoreCase("bye")) {
				...
				System.out.println("Bye" + '\n' + "Total time spent running the elevator is: " + Memory.totaltime
						+ " milliseconds");
				System.out.println(
						Duration.between(Memory.startRunning, Memory.endRunning).toMillis() / 1000 + " Seconds");
				System.out.println(
						Duration.between(Memory.startRunning, Memory.endRunning).toMinutes() + " Minutes" + '\n');
				System.out.println("Total time for Move Process: " + Memory.moveDurationProcess + " milliseconds" + '\n'
						...
						+ '\n');
				System.out.println("Size of Move Process: " + ObjectSizeCalculator.getObjectSize(Memory.move) + " bytes" + '\n'
						+ "Size of Open Door Process: " + ObjectSizeCalculator.getObjectSize(Memory.open) + " bytes" + '\n'
						+ "Size of Close Door Process: " + ObjectSizeCalculator.getObjectSize(Memory.close) + " bytes" + '\n'
						+ "Size of fan Process: " + ObjectSizeCalculator.getObjectSize(Memory.fan) + " bytes" + '\n'
						+ "Size of time Process: " + ObjectSizeCalculator.getObjectSize(Memory.time) + " bytes"+ '\n'
						+ "Size of CurrentFloor Process: " +ObjectSizeCalculator.getObjectSize(Memory.currentFloorProcess) + " bytes"
						+ '\n');
				
				System.out.println("Total memory size:"+((int) (ObjectSizeCalculator.getObjectSize(Memory.move)*3.7+ObjectSizeCalculator.getObjectSize(Memory.time)+ObjectSizeCalculator.getObjectSize(Memory.currentFloorProcess))));
				...
				IO.print("Number of currently running threads is: " + Memory.runningThreads);
