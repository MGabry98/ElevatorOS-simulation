...
public class GUI extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		try (FileWriter writer = new FileWriter("src/logging.txt"); BufferedWriter bw = new BufferedWriter(writer)) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().startsWith("floor")) {
			...
			ProcessTime.processrunstart.add(Memory.timestartprocess);
			ProcessTime.runningNow.add("Time");
			ProcessTime.processmemorysize.add((long) (ObjectSizeCalculator
					.getObjectSize(Memory.time)));
			Control.time(elevator);
		} else if (e.getActionCommand() == "currentfloor") {
			
			Memory.currentFloorStartProcess = Instant.now();
			ProcessTime.processrunstart.add(Memory.currentFloorStartProcess);
			ProcessTime.runningNow.add("Current Floor");
			ProcessTime.processmemorysize.add((long) (ObjectSizeCalculator
